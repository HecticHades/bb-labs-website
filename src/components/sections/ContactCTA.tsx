...
export function ContactCTA() {
  return (
    <section className="py-20 lg:py-32 xl:py-40 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg xl:text-xl text-muted-foreground mb-8 lg:mb-10 max-w-xl xl:max-w-2xl mx-auto">
